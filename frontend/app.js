...
// const contractAddress = "0x493C90Ad532D7d86f4b2D44FC65588473932B322";
...
//   }
//   const exists = await contract.credentialExists(matricNo);
//   console.log("Exists:", exists);
//   console.log("Matric entered:", `"${matricNo}"`);
...
async function issueCredential() {
  ...
  try {
    ...
    if (!studentName || !matricNo || !course || !degree || !year) {
...
async function verifyCredential() {
  try {
    ...
    const matricNo = document
      .getElementById("verifyMatric")
      .value
      .trim();
